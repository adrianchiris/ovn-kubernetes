...
import (
	...
	"github.com/ovn-org/ovn-kubernetes/go-controller/pkg/crd/icmpnetworkpolicy/v1alpha1/apis/clientset/versioned/scheme"
	rest "k8s.io/client-go/rest"
)

type K8sV1alpha1Interface interface {
	RESTClient() rest.Interface
	ICMPNetworkPoliciesGetter
}
...
func (c *K8sV1alpha1Client) ICMPNetworkPolicies(namespace string) ICMPNetworkPolicyInterface {
	return newICMPNetworkPolicies(c, namespace)
}
